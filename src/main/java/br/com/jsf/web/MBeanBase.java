...
public abstract class MBeanBase implements Serializable {
    ...
    protected boolean verConteudoLista;
    ...
    public boolean isVerConteudoLista() {
        return verConteudoLista;
    }

    public void setVerConteudoLista(final boolean verConteudoLista) {
        this.verConteudoLista = verConteudoLista;
    }
